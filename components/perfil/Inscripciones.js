...
const Inscripciones = ({eventos, misInscripciones, t}) => {
        ...
        <Fondo className="py-5 text-center">
            <Container className="mx-auto">
                <TituloBox>
                    ...
                    <Titulo>{t('Inscripciones.Titulo')}</Titulo>
                </TituloBox>
            </Container>
...
Inscripciones.with18nextTranslation = async () => ({
    namespacesRequired: ['perfil'],
});

export default withTranslation('perfil')(Inscripciones);