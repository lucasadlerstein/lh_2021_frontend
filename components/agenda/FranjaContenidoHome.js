...
const FranjaContenidoHome = ({titulo, eventosMostrar}) => {
    ...
    return (
        <>
            ...
            <div className="pt-5px-0">
                ...
                swipeable={true}
                interval={3000}
                infiniteLoop={eventosMostrar.length > 7}
                // autoPlay={true}
                transitionTime={1000}
                // emulateTouch={true}
                showThumbs={false}
                ...
                >
                    {
                        eventosMostrar.map((ev, index) => (
                            <EventoNet
                                ...
                                key={index}
                                imagen={
                                    (i18n.language === 'en' ? `/img/flyers2021/${ev.portadaEN}` : (i18n.language === 'pr') ? `/img/flyers2021/${ev.portadaPR}` : `/img/flyers2021/${ev.portadaES}` )
...
export default FranjaContenidoHome;